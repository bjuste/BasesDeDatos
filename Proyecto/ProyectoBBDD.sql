...
Begin
        ...
        dbms_output.put_line(vDescuento);
        dbms_output.put_line(vTotalDescuento);
EXCEPTION
...
DECLARE
    vNombreCamarero VARCHAR2(30) := 'javi61';
    vCodigoEmpleado VARCHAR2(30);
BEGIN
    -- Validamos si existe el camarero y obtenemos su código de empleado
    SELECT codigoEmpleado INTO vCodigoEmpleado 
    FROM Camarero 
...
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        dbms_outpur.put_line('No se encontro el producto con el codigo asociado');
END;
