...
DECLARE
    ...
    vCodProducto VARCHAR2(100) := '18'; -- Supongamos un c�digo de producto de ejemplo
...
END;
    ...
    BEGIN
        -- Validamos si existe el camarero y obtenemos su c�digo de empleado
        SELECT codEmpleado INTO vCodigoEmpleado 
        FROM Camarero 
        WHERE nombreUsuario = vNombreCamarero;
    EXCEPTION
        WHEN NO_DATA_FOUND THEN
            dbms_output.put_line('No se encontr� ning�n camarero con el nombre de usuario especificado.');
    END;
    ...
    -- Convertimos el c�digo de producto a n�mero
    ...
    -- Mostramos un mensaje indicando que la operaci�n fue exitosa
    DBMS_OUTPUT.PUT_LINE('Venta realizada con �xito. N�mero de ticket: ' || vNumeroTicket);
