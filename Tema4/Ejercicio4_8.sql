...
/*Nueva Sesion ordenar por apellido*/
SELECT * FROM DATOSPERSONALES ORDER BY APELLIDO1, APELLIDO2;
SELECT NOMBRE, NUMHORAS FROM ASIGNATURA;
SELECT NOMBRE as "NOMBRE ASIGNATURA", NUMHORAS/10 as "CREDITOS" FROM ASIGNATURA;
