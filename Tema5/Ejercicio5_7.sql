...
/*J*/
SELECT NOMBRE, PRECIO FROM (SELECT NOMBRE, PRECIO FROM PRODUCTOS ORDER BY PRECIO DESC) WHERE ROWNUM = 1;
/*K*/
SELECT P.NOMBRE FROM PRODUCTOS P WHERE P.PRECIO >=400;
/*I*/
SELECT P.NOMBRE FROM PRODUCTOS P WHERE P.PRECIO <=400;
/*M*/
SELECT * FROM PRODUCTOS P WHERE P.PRECIO >= 80 AND P.PRECIO <= 300;
/*N*/
SELECT * FROM PRODUCTOS P WHERE P.PRECIO BETWEEN 60 AND 200;
/*O*/
SELECT * FROM PRODUCTOS P WHERE P.PRECIO >200 AND P.ID_FABRICANTE=6;
/*P*/
SELECT * FROM PRODUCTOS P WHERE P.ID_FABRICANTE IN (1,3,5);
/*Q*/
SELECT F.NOMBRE FROM FABRICANTES F WHERE F.NOMBRE LIKE 'S%';
/*R*/
SELECT F.NOMBRE FROM FABRICANTES F WHERE F.NOMBRE LIKE '%E';
/*S*/
SELECT F.NOMBRE FROM FABRICANTES F WHERE F.NOMBRE LIKE '%_W_%';
...
/*15*/
SELECT MAX(PRECIO), MIN(PRECIO), AVG(PRECIO), COUNT(*) FROM PRODUCTOS WHERE ID_FABRICANTE IN (SELECT ID_FABRICANTE FROM PRODUCTOS GROUP BY ID_FABRICANTE HAVING AVG(PRECIO)>200) GROUP BY PRECIO;
/*16*/
SELECT F.NOMBRE, MAX(PRECIO), MIN(PRECIO), AVG(PRECIO), COUNT(*) FROM FABRICANTES F JOIN PRODUCTOS P ON F.ID=P.ID_FABRICANTE GROUP BY F.NOMBRE HAVING AVG(PRECIO)>200;
/*17*/
SELECT COUNT(*) FROM PRODUCTOS WHERE PRECIO >=180;
/*18*/
SELECT F.NOMBRE, COUNT(P.ID) FROM FABRICANTES F JOIN PRODUCTOS P ON F.ID=P.ID_FABRICANTE WHERE P.PRECIO >=180 GROUP BY F.NOMBRE;
/*19*/
SELECT P.ID_FABRICANTE, AVG(P.PRECIO) FROM PRODUCTOS P GROUP BY P.ID_FABRICANTE;
/*20*/
SELECT F.NOMBRE, AVG(P.PRECIO) FROM FABRICANTES F JOIN PRODUCTOS P ON F.ID=P.ID_FABRICANTE GROUP BY F.NOMBRE;
/*21*/
SELECT F.NOMBRE FROM FABRICANTES F JOIN PRODUCTOS P ON F.ID=P.ID_FABRICANTE GROUP BY F.NOMBRE HAVING AVG(P.PRECIO)>=150;
/*22*/
SELECT F.NOMBRE FROM FABRICANTES F JOIN PRODUCTOS P ON F.ID = P.ID_FABRICANTE GROUP BY F.NOMBRE HAVING COUNT(P.ID) >= 2;
/*GROUP BY*/
/*1*/
